...
@section('content')
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
        <div>
            <img src="https://cdn.pixabay.com/photo/2016/03/26/13/09/workspace-1280538_960_720.jpg" width="700" alt="">
        </div>
    ...
    <div class="text-center p-15 bg-black text-white">
        ...
        <span class="font-extrabold text-4xl py-1">
            Ux Design
        </span>
        <span class="font-extrabold text-4xl py-1">
            Project Management
        ...
        <div class="flex bg-yellow-700 text-gray-100 pt-10">
            <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block">
                ...
                <a href="" class="uppercase bg-transparent border-2
                 border-gray-100 text-gray-100 text-xs font-extrabold py-3 px-5 rounded-3xl">Find Out More</a>
            </div>
        </div>
        <div>
            <img src="https://cdn.pixabay.com/photo/2016/03/26/13/09/workspace-1280538_960_720.jpg" width="700" alt="">
