...
<div class="w-4/5 m-auto">
    <ul>
        @foreach ($errors->all() as $error)
            <li class="w-1/5 mb-4 text-gray-50 bg-red-700 rounded-2xl py-40">{{ $error }}</li>
        @endforeach
    </ul>
</div>
...
<div class="w-4/5 m-auto pt-20">
    ...
    @csrf
    <input type="text" name="title" id="title" placeholder="Title" class="bg-transparent block border-b-2 w-full h-20 text-6xl outline-none">
